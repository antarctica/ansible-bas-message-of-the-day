# Message Of The Day (`motd`) - Testing
...
1. `test-bare` - Creates a single machine with a custom Message Of The Day
...
| ------------------------- | ----------------- | ------------------------------- | --------------------------- |
| bas-motd-test-ubuntu-bare | *computed value*  | `bas-motd-test-ubuntu-bare.v.m` | The VM's private IP address |
| bas-motd-test-centos-bare | *computed value*  | `bas-motd-test-centos-bare.v.m` | The VM's private IP address |
